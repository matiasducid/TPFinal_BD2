...
BEGIN
	...
	FOR row_temp IN cursor_temp LOOP
		...
		INSERT INTO "Eq_Ventas" VALUES(null,null,null,null,null,row_temp.fecha,
			row_temp.tiempo,row_temp.id_prod,row_temp.cantidad,
			row_temp.precio,row_temp.factura,row_temp.cliente,row_temp.nombre,medio);
	END LOOP;
END
$$
LANGUAGE plpgsql;
	...
	FOR row_venta IN cursor_ventas LOOP
		...
		ELSE
			...
			INSERT INTO "Ventas" VALUES (row_venta."Fecha_Vta2",row_venta."Id_Tiempo2",row_venta."claveDW_Ventas",
						(SELECT nueva_clave FROM "Eq_Clientes" WHERE row_venta."cod_Cliente2"="Eq_Clientes".idc2)
